...
<body>
    ...
    <div id="template-mo-zay-hero-carousel" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
                ...
                <div class="container">
                    <div class="row p-5">
                        <div class="mx-auto col-md-8 col-lg-6 order-lg-last">
                            <img class="img-fluid" src="${pageContext.request.contextPath}/resources/assets/img/img_product/${RandomProduct.get(2).getImage()}" alt="">
                        </div>
                        <div class="col-lg-6 mb-0 d-flex align-items-center">
                            <div class="text-align-left">
                                <h1 class="h1 text-success"><b>Zay</b> ${RandomProduct.get(2).getName()}</h1>
                                <p>
                                    ${RandomProduct.get(2).getDescription()}
                                </p>
                            </div>
                        </div>
                    </div>
         ...
         <c:forEach var="item" items="${RandomProduct}">
            <div class="carousel-item">
                <div class="container">
                    <div class="row p-5">
                        <div class="mx-auto col-md-8 col-lg-6 order-lg-last">
                            <img class="img-fluid" src="${pageContext.request.contextPath}/resources/assets/img/img_product/${item.getImage()}" alt="">
                        </div>
                        <div class="col-lg-6 mb-0 d-flex align-items-center">
                            <div class="text-align-left align-self-center">
                                <h1 class="h1 text-success"><b>Zay</b> ${item.getName()}</h1>
                                <h3 class="h2">Tiny and Perfect eCommerce Template</h3>
                                <p>
                                    ${item.getDescription()} <a rel="sponsored" class="text-success" href="https://stories.freepik.com/" target="_blank">Freepik Stories</a>,
