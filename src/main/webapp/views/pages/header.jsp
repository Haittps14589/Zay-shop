		...
		<div
			...
			<div class="navbar align-self-center d-flex">
				...
				<a class="nav-icon d-none d-lg-inline" href="#"
					...
					class="position-absolute top-0 left-100 translate-middle badge rounded-pill bg-light text-dark">${sessionScope.cartDetails.size()}</span>
				</a>
				<div class="ml-auto">
					<div class="dropdown sub-dropdown">
						...
						<div class="dropdown-menu dropdown-menu-right"
							...
							<c:if test="${sessionScope.user.isRole() == true}">
								<a class="dropdown-item" href="${url}admin">Trang Quản lý</a>
							</c:if>
							<a class="dropdown-item" href="${url}user">thông tin người
								dùng</a> <a class="dropdown-item" href="${url}cart">Giỏ hàng</a> <a
								class="dropdown-item" href="${url}user/sign-out">Đăng xuất</a>
